...
dataPath ="/home/koulkoudakis/p06/data"
...
async def getCountry(country_name, coords_only: bool = False):
    ...
    f = Feature(coords=largest, properties={"name": country_name, "stroke": "#000000", "stroke-width": 2, "stroke-opacity": 1}) ###########"stroke": "#00ff40"}
